...
ApexTran_HOOK_NAMESPACE = "ApexTran"
hookspec = pluggy.HookspecMarker(ApexTran_HOOK_NAMESPACE)
hookimpl = pluggy.HookimplMarker(ApexTran_HOOK_NAMESPACE)


class ApexTranHookSpecs:
    """Hook contract for ApexTran framework extensions."""
    ...
    def provide_tape_store(self) -> TapeStore | AsyncTapeStore:
        """Provide a tape store instance for ApexTran's conversation recording feature."""
        raise NotImplementedError
