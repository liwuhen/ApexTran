"""Hook-first ApexTran framework runtime."""
...
from backend.hooks.hookspecs import ApexTran_HOOK_NAMESPACE, ApexTranHookSpecs
...
class ApexTranFramework:
    """Minimal framework core. Everything grows from hook skills."""

    def __init__(self) -> None:
        self.workspace = Path.cwd().resolve()
        self._plugin_manager = pluggy.PluginManager(ApexTran_HOOK_NAMESPACE)
        self._plugin_manager.add_hookspecs(ApexTranHookSpecs)
    ...
    def load_hooks(self) -> None:
        ...
        for entry_point in importlib.metadata.entry_points(group="ApexTran"):
            try:
    ...
    def create_cli_app(self) -> typer.Typer:
        ...
        app = typer.Typer(name="ApexTran", help="Batteries-included, hook-first AI framework", add_completion=False)
