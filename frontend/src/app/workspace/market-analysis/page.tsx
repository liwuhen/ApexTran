...
export default function MarketAnalysisPage() {
  ...
  useEffect(() => {
    document.title = `${t.sidebar.marketAnalysis} - ${t.pages.appName}`;
  }, [t.sidebar.marketAnalysis, t.pages.appName]);
      ...
      <WorkspaceBody>
        <div className="flex size-full flex-col items-center justify-center gap-3 p-6 text-center">
          <div className="bg-accent text-foreground flex size-14 items-center justify-center rounded-2xl">
            <CandlestickChartIcon className="size-7" />
          </div>
          <h1 className="text-2xl font-bold">{t.sidebar.marketAnalysis}</h1>
