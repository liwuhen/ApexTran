...
export default function MarketHotspotsPage() {
  ...
  useEffect(() => {
    document.title = `${t.sidebar.marketHotspots} - ${t.pages.appName}`;
  }, [t.sidebar.marketHotspots, t.pages.appName]);
    ...
    <WorkspaceContainer>
      ...
      <WorkspaceBody>
        <div className="flex size-full flex-col items-center justify-center gap-3 p-6 text-center">
          ...
          <h1 className="text-2xl font-bold">{t.sidebar.marketHotspots}</h1>
