...
export default function StockHeadlinesPage() {
  ...
  useEffect(() => {
    document.title = `${t.sidebar.stockHeadlines} - ${t.pages.appName}`;
  }, [t.sidebar.stockHeadlines, t.pages.appName]);
    ...
    <WorkspaceContainer>
      ...
      <WorkspaceBody>
        <div className="flex size-full flex-col items-center justify-center gap-3 p-6 text-center">
          ...
          <h1 className="text-2xl font-bold">{t.sidebar.stockHeadlines}</h1>
