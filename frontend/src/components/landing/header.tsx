  ...
  return (
    ...
    >
      <div className="flex items-center gap-6">
        <a
          href={homeURL ?? "https://github.com/XLab-Open/ApexTran"}
          target={isExternalHome ? "_blank" : "_self"}
          rel={isExternalHome ? "noopener noreferrer" : undefined}
        >
          <h1 className="font-serif text-xl">ApexTran</h1>
        </a>
      </div>
      <div className="relative ml-auto">
        ...
        >
          <a
            href="https://github.com/XLab-Open/ApexTran"
            target="_blank"
...
async function StarCounter() {
  ...
  try {
    const response = await fetch(
      "https://api.github.com/repos/XLab-Open/ApexTran",
      {
